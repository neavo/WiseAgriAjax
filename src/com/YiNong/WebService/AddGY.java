 ...
 *         &lt;element name="product_place_id" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
public class AddGY {
    ...
    @XmlElement(name = "product_place_id")
    protected int productPlaceId;
    ...
    /**
     * 设置productPlaceId属性的值。
     * 
     */
    public void setProductPlaceId(int value) {
        this.productPlaceId = value;
    }
